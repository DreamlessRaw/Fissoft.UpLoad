...
namespace Fissoft.UpLoad
{
    ...
    {
        public static string Host { get; set; } = ImageConfig.Instance.Host;
        public static string ApiKey { get; set; } = ImageConfig.Instance.ApiKey;

        public static string UploadUrl { get; set; } = ImageConfig.Instance.UploadUrl;
